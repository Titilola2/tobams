...
const Delicious: React.FC<DeliciousProps> = () => {
  return (
    <div className="flex flex-col  mx-16 my-24   ">
      ...
      <div className="w-2/5 font-[600] lg:text-[2.8rem] md:text-[2rem] text-[1rem]">Try this delicious recipe   to make your day</div>
      ...
      <div className=" w-[18.125rem] h-[291.2px] bg-[#ffffff] rounded-[30px] flex flex-col gap-y-2">
