...
const Tasty: React.FC<TastyProps> = () => {
  return (
    <div className="flex flex-col  mx-16 my-8 gap-4  ">
      ...
      <div className=" w-[22rem] h-[434px] bg-gradient-to-b from-[#ffffff] to-[#E7F9FD] rounded-[30px] flex flex-col gap-y-2">
        ...
        <div className=" w-[22rem] h-[434px] bg-gradient-to-b from-[#ffffff] to-[#E7F9FD] rounded-[30px] ">
