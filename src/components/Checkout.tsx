...
const Checkout: React.FC<CheckoutProps> = () => {
  return (
    <div className="flex flex-col px-12 py-12 my-12  bg-gradient-to-b from-[#ffffff] to-[#E7F9FD]  ">
      <div className="text-center font-inter font-[600] text-[2.7rem]">Check out @foodieland on Instagram</div>
      <div className="text-center font-inter font-[400] text-[1rem] flex justify-center items-center relative left-[280px] w-[58%] opacity-[60%] md:mx-84 mt-8 mb-16">Lorem ipsum dolor sit amet, consectetuipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqut enim ad minim </div>
